...
// function accepts person argument, however it is set to optional
function twoFer(person?: string): string {
    // optional parameter returns undefined if not filled, so run a null check to set the recepient string
